...
main_body:
  ...
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".5")
  %".6" = bitcast [4 x i8]* @"str_3" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".6", i64 %"fib_call")
  %".7" = bitcast [2 x i8]* @"str_4" to i8*
