...
for_body:
  ...
  %".17" = getelementptr i64, i64* %"a_load", i64 %"i_load.1"
  store i64 %"mod", i64* %".17"
  %"i_load.2" = load i64, i64* %"i"
  %"mul.1" = mul i64 %"i_load.2", 2
  %"mod.1" = srem i64 %"mul.1", 10
  %"b_load" = load i64*, i64** %"b"
  %"i_load.3" = load i64, i64* %"i"
  %".19" = getelementptr i64, i64* %"b_load", i64 %"i_load.3"
  store i64 %"mod.1", i64* %".19"
  %"c_load" = load i64*, i64** %"c"
  %"i_load.4" = load i64, i64* %"i"
  %".21" = getelementptr i64, i64* %"c_load", i64 %"i_load.4"
  store i64 0, i64* %".21"
  br label %"for_inc"
for_inc:
...
for_body.3:
  ...
  %".36" = getelementptr i64, i64* %"a_load.1", i64 %"add"
  %"ptr_idx_load" = load i64, i64* %".36"
  ...
  %".37" = getelementptr i64, i64* %"b_load.1", i64 %"add.1"
  %"ptr_idx_load.1" = load i64, i64* %".37"
...
for_end.3:
  ...
  %".42" = getelementptr i64, i64* %"c_load.1", i64 %"add.3"
  store i64 %"s_load.1", i64* %".42"
  br label %"for_inc.2"
for_cond.8:
...
for_body.4:
  ...
  %".54" = getelementptr i64, i64* %"c_load.2", i64 %"i_load.7"
  %"ptr_idx_load.2" = load i64, i64* %".54"
...
for_end.4:
  ...
  %".59" = bitcast [4 x i8]* @"str_1" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".59", i64 %"total_load.1")
  %".60" = bitcast [2 x i8]* @"str_2" to i8*
  %"print_nl" = call i32 (i8*, ...) @"printf"(i8* %".60")
  ret i64 0
}
