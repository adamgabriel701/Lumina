...
for_body:
  ...
  %"mul" = mul i64 %"t_load", %"i_load.1"
  %"icmp" = icmp slt i64 %"mul", 0
...
for_end:
  ...
  %".21" = bitcast [3 x i8]* @"str_1" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".21", i8* %".20")
  %"acc_load.1" = load i64, i64* %"acc"
  %".22" = bitcast [2 x i8]* @"str_2" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".22")
  %".23" = bitcast [4 x i8]* @"str_3" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".23", i64 %"acc_load.1")
  %".24" = bitcast [2 x i8]* @"str_4" to i8*
  %"print_nl" = call i32 (i8*, ...) @"printf"(i8* %".24")
