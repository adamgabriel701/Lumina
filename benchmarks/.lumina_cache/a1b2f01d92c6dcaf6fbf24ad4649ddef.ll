...
for_body:
  ...
  %".8" = getelementptr i8, i8* %"primes_load", i64 %"i_load"
  %"idx_trunc" = trunc i64 1 to i8
  store i8 %"idx_trunc", i8* %".8"
  br label %"for_inc"
for_inc:
...
for_end:
  ...
  %".13" = getelementptr i8, i8* %"primes_load.1", i64 0
  %"idx_trunc.1" = trunc i64 0 to i8
  store i8 %"idx_trunc.1", i8* %".13"
  %"primes_load.2" = load i8*, i8** %"primes"
  %".15" = getelementptr i8, i8* %"primes_load.2", i64 1
  %"idx_trunc.2" = trunc i64 0 to i8
  store i8 %"idx_trunc.2", i8* %".15"
  %"p" = alloca i64
  store i64 2, i64* %"p"
  br label %"while_cond"
while_cond:
...
while_body:
  ...
  %".20" = getelementptr i8, i8* %"primes_load.3", i64 %"p_load.2"
...
while_body.1:
  ...
  %".25" = getelementptr i8, i8* %"primes_load.4", i64 %"i_load.2"
  %"idx_trunc.3" = trunc i64 0 to i8
  store i8 %"idx_trunc.3", i8* %".25"
...
for_body.1:
  ...
  %".37" = getelementptr i8, i8* %"primes_load.5", i64 %"i_load.4"
  %"ptr_idx_load.1" = load i8, i8* %".37"
...
for_inc.1:
  ...
  br label %"for_cond.2"
for_end.1:
  %".45" = bitcast [1 x i8]* @"str_0" to i8*
  %".46" = bitcast [3 x i8]* @"str_1" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".46", i8* %".45")
  ...
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".48", i64 %"count_load.1")
