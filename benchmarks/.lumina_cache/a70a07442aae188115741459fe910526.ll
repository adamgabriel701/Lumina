...
for_body:
  ...
  %".15" = getelementptr i64, i64* %"a_load", i64 %"i_load.1"
  store i64 %"mod", i64* %".15"
  %"i_load.2" = load i64, i64* %"i"
  %"mul.1" = mul i64 %"i_load.2", 2
  %"mod.1" = srem i64 %"mul.1", 10
  %"b_load" = load i64*, i64** %"b"
  %"i_load.3" = load i64, i64* %"i"
  %".17" = getelementptr i64, i64* %"b_load", i64 %"i_load.3"
  store i64 %"mod.1", i64* %".17"
  %"c_load" = load i64*, i64** %"c"
  %"i_load.4" = load i64, i64* %"i"
  %".19" = getelementptr i64, i64* %"c_load", i64 %"i_load.4"
  store i64 0, i64* %".19"
  br label %"for_inc"
for_inc:
...
for_body.3:
  ...
  %".34" = getelementptr i64, i64* %"a_load.1", i64 %"add"
  %"ptr_idx_load" = load i64, i64* %".34"
  ...
  %".35" = getelementptr i64, i64* %"b_load.1", i64 %"add.1"
  %"ptr_idx_load.1" = load i64, i64* %".35"
...
for_end.3:
  ...
  %".40" = getelementptr i64, i64* %"c_load.1", i64 %"add.3"
  store i64 %"s_load.1", i64* %".40"
  br label %"for_inc.2"
for_cond.8:
...
for_body.4:
  ...
  %".52" = getelementptr i64, i64* %"c_load.2", i64 %"i_load.7"
  %"ptr_idx_load.2" = load i64, i64* %".52"
...
for_inc.4:
  ...
  br label %"for_cond.8"
for_end.4:
  %".57" = bitcast [1 x i8]* @"str_0" to i8*
  %".58" = bitcast [3 x i8]* @"str_1" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".58", i8* %".57")
  %"total_load.1" = load i64, i64* %"total"
  %".59" = bitcast [2 x i8]* @"str_2" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".59")
  %".60" = bitcast [4 x i8]* @"str_3" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".60", i64 %"total_load.1")
  %".61" = bitcast [2 x i8]* @"str_4" to i8*
  %"print_nl" = call i32 (i8*, ...) @"printf"(i8* %".61")
