...
main_body:
  ...
  %"limit_str" = alloca i8*
  store i8* %"argv_elem", i8** %"limit_str"
  %"limit" = alloca i64
...
for_inc:
  ...
  br label %"for_cond"
for_end:
  %".22" = bitcast [11 x i8]* @"str_0" to i8*
  %".23" = bitcast [3 x i8]* @"str_1" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".23", i8* %".22")
  %"x_load.1" = load i64, i64* %"x"
  %".24" = bitcast [2 x i8]* @"str_2" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".24")
  %".25" = bitcast [4 x i8]* @"str_3" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".25", i64 %"x_load.1")
  %".26" = bitcast [2 x i8]* @"str_4" to i8*
  %"print_nl" = call i32 (i8*, ...) @"printf"(i8* %".26")
  ...
  %".31" = bitcast [16 x i8]* @"str_5" to i8*
  %".32" = bitcast [3 x i8]* @"str_6" to i8*
  %"print_call.2" = call i32 (i8*, ...) @"printf"(i8* %".32", i8* %".31")
  %"sec_load" = load double, double* %"sec"
  %".33" = bitcast [2 x i8]* @"str_7" to i8*
  %"print_sep.1" = call i32 (i8*, ...) @"printf"(i8* %".33")
  %".34" = bitcast [3 x i8]* @"str_8" to i8*
  %"print_call.3" = call i32 (i8*, ...) @"printf"(i8* %".34", double %"sec_load")
  %".35" = bitcast [9 x i8]* @"str_9" to i8*
  %".36" = bitcast [2 x i8]* @"str_10" to i8*
  %"print_sep.2" = call i32 (i8*, ...) @"printf"(i8* %".36")
  %".37" = bitcast [3 x i8]* @"str_11" to i8*
  %"print_call.4" = call i32 (i8*, ...) @"printf"(i8* %".37", i8* %".35")
  %".38" = bitcast [2 x i8]* @"str_12" to i8*
  %"print_nl.1" = call i32 (i8*, ...) @"printf"(i8* %".38")
