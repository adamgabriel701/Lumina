...
main_body:
  ...
  %".4" = bitcast [10 x i8]* @"str_0" to i8*
  %".5" = bitcast [3 x i8]* @"str_1" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".5", i8* %".4")
  %"result_load" = load i64, i64* %"result"
  %".6" = bitcast [2 x i8]* @"str_2" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".6")
  %".7" = bitcast [4 x i8]* @"str_3" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".7", i64 %"result_load")
  %".8" = bitcast [2 x i8]* @"str_4" to i8*
