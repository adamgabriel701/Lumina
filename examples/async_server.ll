...
if_then:
  %".10" = bitcast [25 x i8]* @"str_0" to i8*
...
if_else:
  br label %"if_end"
if_end:
  %".15" = bitcast [45 x i8]* @"str_3" to i8*
  %".16" = bitcast [3 x i8]* @"str_4" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".16", i8* %".15")
  %"porta_load.1" = load i64, i64* %"porta"
  %".17" = bitcast [2 x i8]* @"str_5" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".17")
  %".18" = bitcast [4 x i8]* @"str_6" to i8*
  ...
  %"icmp.1" = icmp slt i64 %"epfd_load", 0
...
if_end.1:
  ...
  call void @"adicionar"(i64 %"epfd_load.1", i64 %"server_fd_load.1")
...
while_body:
  %"epfd_load.2" = load i64, i64* %"epfd"
  %"esperar_call" = call i64* @"esperar"(i64 %"epfd_load.2", i64 10)
  ...
  %"icmp.2" = icmp ne i64 %"bin_ptrtoint_l", 0
...
if_then.2:
  ...
  %"icmp.3" = icmp sge i64 %"client_fd_load", 0
...
if_then.3:
  ...
  %".33" = bitcast [64 x i8]* @"str_8" to i8*
  %"resp" = alloca i8*
  store i8* %".33", i8** %"resp"
  %"client_fd_load.2" = load i64, i64* %"client_fd"
  %"resp_load" = load i8*, i8** %"resp"
  %"resp_load.1" = load i8*, i8** %"resp"
  %"len_str" = call i64 @"strlen"(i8* %"resp_load.1")
  %"send_call" = call i64 @"send"(i64 %"client_fd_load.2", i8* %"resp_load", i64 %"len_str", i64 0)
...
criar_body:
  ...
  br i1 %"icmp", label %"if_then", label %"if_else"
if_then:
  %".5" = bitcast [20 x i8]* @"str_16" to i8*
  %".6" = bitcast [3 x i8]* @"str_17" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".6", i8* %".5")
  %".7" = bitcast [2 x i8]* @"str_18" to i8*
...
@"str_0" = constant [25 x i8] c"Erro ao iniciar servidor\00"
@"str_1" = constant [3 x i8] c"%s\00"
@"str_2" = constant [2 x i8] c"\0a\00"
@"str_3" = constant [45 x i8] c"\f0\9f\9a\80 Servidor Async (epoll) rodando na porta\00"
@"str_4" = constant [3 x i8] c"%s\00"
@"str_5" = constant [2 x i8] c" \00"
@"str_6" = constant [4 x i8] c"%ld\00"
@"str_7" = constant [2 x i8] c"\0a\00"
@"str_8" = constant [64 x i8] c"HTTP/1.1 200 OK\0d\0aContent-Length: 18\0d\0a\0d\0a<h1>Async Epoll OK!</h1>\00"
...
@"str_16" = constant [20 x i8] c"Erro ao criar epoll\00"
