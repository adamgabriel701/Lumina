...
declare i64 @"cpp_multiply"(i64 %".1", i64 %".2")

declare void @"cpp_print_hello"()
...
main_body:
  ...
  call void @"cpp_print_hello"()
  %"cpp_multiply_call" = call i64 @"cpp_multiply"(i64 10, i64 5)
  %"res" = alloca i64
  store i64 %"cpp_multiply_call", i64* %"res"
  %".11" = bitcast [28 x i8]* @"str_3" to i8*
...
@"str_0" = constant [24 x i8] c"Testando FFI com C++...\00"
@"str_1" = constant [3 x i8] c"%s\00"
@"str_2" = constant [2 x i8] c"\0a\00"
@"str_3" = constant [28 x i8] c"C++ multiplicou e retornou:\00"
