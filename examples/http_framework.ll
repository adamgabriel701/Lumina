...
define %"Response"* @"handle_request"(i8* %".1")
{
handle_request_entry:
  %"path" = alloca i8*
  store i8* %".1", i8** %"path"
  br label %"handle_request_body"
handle_request_body:
  %"path_load" = load i8*, i8** %"path"
  %".5" = bitcast [2 x i8]* @"str_0" to i8*
  %"strcmp_call" = call i32 @"strcmp"(i8* %"path_load", i8* %".5")
  %"str_eq" = icmp eq i32 %"strcmp_call", 0
  br i1 %"str_eq", label %"match_str_case", label %"match_str_next"
match_str_end:
  %"match_str_res" = phi  %"Response"* [%"response_lit", %"match_str_case"], [%"response_lit.1", %"match_str_case.1"], [%"response_lit.2", %"match_str_case.2"], [%"response_lit.3", %"match_str_next.2"]
  ret %"Response"* %"match_str_res"
match_str_case:
  %"response_lit" = alloca %"Response"
  %"status_ptr" = getelementptr %"Response", %"Response"* %"response_lit", i32 0, i32 0
  store i64 200, i64* %"status_ptr"
  %"body_ptr" = getelementptr %"Response", %"Response"* %"response_lit", i32 0, i32 1
  %".8" = bitcast [20 x i8]* @"str_1" to i8*
  store i8* %".8", i8** %"body_ptr"
  br label %"match_str_end"
match_str_next:
  %".11" = bitcast [8 x i8]* @"str_2" to i8*
  %"strcmp_call.1" = call i32 @"strcmp"(i8* %"path_load", i8* %".11")
  %"str_eq.1" = icmp eq i32 %"strcmp_call.1", 0
  br i1 %"str_eq.1", label %"match_str_case.1", label %"match_str_next.1"
match_str_case.1:
  %"response_lit.1" = alloca %"Response"
  %"status_ptr.1" = getelementptr %"Response", %"Response"* %"response_lit.1", i32 0, i32 0
  store i64 200, i64* %"status_ptr.1"
  %"body_ptr.1" = getelementptr %"Response", %"Response"* %"response_lit.1", i32 0, i32 1
  %".14" = bitcast [8 x i8]* @"str_3" to i8*
  store i8* %".14", i8** %"body_ptr.1"
  br label %"match_str_end"
match_str_next.1:
  %".17" = bitcast [5 x i8]* @"str_4" to i8*
  %"strcmp_call.2" = call i32 @"strcmp"(i8* %"path_load", i8* %".17")
  %"str_eq.2" = icmp eq i32 %"strcmp_call.2", 0
  br i1 %"str_eq.2", label %"match_str_case.2", label %"match_str_next.2"
match_str_case.2:
  %"response_lit.2" = alloca %"Response"
  %"status_ptr.2" = getelementptr %"Response", %"Response"* %"response_lit.2", i32 0, i32 0
  store i64 200, i64* %"status_ptr.2"
  %"body_ptr.2" = getelementptr %"Response", %"Response"* %"response_lit.2", i32 0, i32 1
  %".20" = bitcast [20 x i8]* @"str_5" to i8*
  store i8* %".20", i8** %"body_ptr.2"
  br label %"match_str_end"
match_str_next.2:
  %"response_lit.3" = alloca %"Response"
  %"status_ptr.3" = getelementptr %"Response", %"Response"* %"response_lit.3", i32 0, i32 0
  store i64 404, i64* %"status_ptr.3"
  %"body_ptr.3" = getelementptr %"Response", %"Response"* %"response_lit.3", i32 0, i32 1
  %".24" = bitcast [10 x i8]* @"str_6" to i8*
  store i8* %".24", i8** %"body_ptr.3"
  br label %"match_str_end"
}
...
if_then:
  %".10" = bitcast [25 x i8]* @"str_7" to i8*
  %".11" = bitcast [3 x i8]* @"str_8" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".11", i8* %".10")
  %".12" = bitcast [2 x i8]* @"str_9" to i8*
...
if_else:
  br label %"if_end"
if_end:
  %".15" = bitcast [34 x i8]* @"str_10" to i8*
  %".16" = bitcast [3 x i8]* @"str_11" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".16", i8* %".15")
  %"porta_load.1" = load i64, i64* %"porta"
  %".17" = bitcast [2 x i8]* @"str_12" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".17")
  %".18" = bitcast [4 x i8]* @"str_13" to i8*
  %"print_call.2" = call i32 (i8*, ...) @"printf"(i8* %".18", i64 %"porta_load.1")
  %".19" = bitcast [2 x i8]* @"str_14" to i8*
...
if_then.2:
  ...
  %".31" = bitcast [1 x i8]* @"str_15" to i8*
  %"path" = alloca i8*
  store i8* %".31", i8** %"path"
  %"i" = alloca i64
  store i64 4, i64* %"i"
...
while_cond.1:
  ...
  %"icmp.3" = icmp slt i64 %"i_load", 100
  br i1 %"icmp.3", label %"while_body.1", label %"while_end.1"
while_body.1:
  %"request_buffer_load.1" = load i8*, i8** %"request_buffer"
  %"i_load.1" = load i64, i64* %"i"
  %".36" = getelementptr i8, i8* %"request_buffer_load.1", i64 %"i_load.1"
  %"ptr_idx_load" = load i8, i8* %".36"
  %"idx_sext" = sext i8 %"ptr_idx_load" to i64
  %"c" = alloca i64
  store i64 %"idx_sext", i64* %"c"
  %"c_load" = load i64, i64* %"c"
  %"icmp.4" = icmp eq i64 %"c_load", 32
  br i1 %"icmp.4", label %"or_end", label %"or_rhs"
while_end.1:
  %".48" = bitcast [23 x i8]* @"str_16" to i8*
  %".49" = bitcast [3 x i8]* @"str_17" to i8*
  %"print_call.3" = call i32 (i8*, ...) @"printf"(i8* %".49", i8* %".48")
  %"path_load.1" = load i8*, i8** %"path"
  %".50" = bitcast [2 x i8]* @"str_18" to i8*
  %"print_sep.1" = call i32 (i8*, ...) @"printf"(i8* %".50")
  %".51" = bitcast [3 x i8]* @"str_19" to i8*
  %"print_call.4" = call i32 (i8*, ...) @"printf"(i8* %".51", i8* %"path_load.1")
  %".52" = bitcast [2 x i8]* @"str_20" to i8*
  %"print_nl.2" = call i32 (i8*, ...) @"printf"(i8* %".52")
  %"path_load.2" = load i8*, i8** %"path"
  %"handle_request_call" = call %"Response"* @"handle_request"(i8* %"path_load.2")
  %"res" = alloca %"Response"*
  store %"Response"* %"handle_request_call", %"Response"** %"res"
  %"http_resp" = alloca i8*
  %"int_to_str_buf" = alloca [32 x i8]
  %"int_str_ptr" = bitcast [32 x i8]* %"int_to_str_buf" to i8*
  %".54" = bitcast [4 x i8]* @"str_21" to i8*
  %"int_to_str_call" = call i32 (i8*, i64, i8*, ...) @"snprintf"(i8* %"int_str_ptr", i64 32, i8* %".54", i64 0)
  store i8* %"int_str_ptr", i8** %"http_resp"
  %"client_fd_load.2" = load i64, i64* %"client_fd"
  %"http_resp_load" = load i8*, i8** %"http_resp"
  %"http_resp_load.1" = load i8*, i8** %"http_resp"
  %"len_str" = call i64 @"strlen"(i8* %"http_resp_load.1")
  %"send_call" = call i64 @"send"(i64 %"client_fd_load.2", i8* %"http_resp_load", i64 %"len_str", i64 0)
  %"client_fd_load.3" = load i64, i64* %"client_fd"
  %"close_call" = call i64 @"close"(i64 %"client_fd_load.3")
  br label %"if_end.2"
or_rhs:
  %"c_load.1" = load i64, i64* %"c"
  %"icmp.5" = icmp eq i64 %"c_load.1", 0
  br label %"or_end"
or_end:
  %"or_result" = phi  i1 [1, %"while_body.1"], [%"icmp.5", %"or_rhs"]
  br i1 %"or_result", label %"if_then.3", label %"if_else.3"
if_then.3:
...
if_end.3:
  ...
  %"chr_trunc" = trunc i64 %"c_load.2" to i8
  ...
  %"sconcat_len1" = call i64 @"strlen"(i8* %"path_load")
  ...
  %"sconcat_cpy" = call i8* @"strcpy"(i8* %"sconcat_buf", i8* %"path_load")
  %"sconcat_cat" = call i8* @"strcat"(i8* %"sconcat_buf", i8* %"chr_buf")
  store i8* %"sconcat_buf", i8** %"path"
...
responder_body:
  ...
  %".9" = bitcast [24 x i8]* @"str_24" to i8*
...
not_found_body:
  %".5" = bitcast [37 x i8]* @"str_25" to i8*
  %"body" = alloca i8*
  store i8* %".5", i8** %"body"
  %".7" = bitcast [66 x i8]* @"str_26" to i8*
  %"body_load" = load i8*, i8** %"body"
  %"len_str" = call i64 @"strlen"(i8* %"body_load")
  %".8" = bitcast [4 x i8]* @"str_27" to i8*
  %"num_to_str" = alloca [64 x i8]
  %"num_to_str_ptr" = bitcast [64 x i8]* %"num_to_str" to i8*
  %"num_to_str_call" = call i32 (i8*, i64, i8*, ...) @"snprintf"(i8* %"num_to_str_ptr", i64 64, i8* %".8", i64 %"len_str")
  %"sconcat_len1" = call i64 @"strlen"(i8* %".7")
  ...
  %"sconcat_cpy" = call i8* @"strcpy"(i8* %"sconcat_buf", i8* %".7")
  %"sconcat_cat" = call i8* @"strcat"(i8* %"sconcat_buf", i8* %"num_to_str_ptr")
  %".9" = bitcast [24 x i8]* @"str_28" to i8*
  %"sconcat_len1.1" = call i64 @"strlen"(i8* %"sconcat_buf")
  %"sconcat_len2.1" = call i64 @"strlen"(i8* %".9")
  %"sconcat_sum.1" = add i64 %"sconcat_len1.1", %"sconcat_len2.1"
  %"sconcat_total.1" = add i64 %"sconcat_sum.1", 1
...
criar_body:
  ...
  br i1 %"icmp", label %"if_then", label %"if_else"
if_then:
  %".5" = bitcast [20 x i8]* @"str_29" to i8*
  %".6" = bitcast [3 x i8]* @"str_30" to i8*
  %"print_call" = call i32 (i8*, ...) @"printf"(i8* %".6", i8* %".5")
  %".7" = bitcast [2 x i8]* @"str_31" to i8*
...
@"str_1" = constant [20 x i8] c"Bem-vindo a Lumina!\00"
@"str_2" = constant [8 x i8] c"/health\00"
@"str_3" = constant [8 x i8] c"Healthy\00"
@"str_4" = constant [5 x i8] c"/api\00"
@"str_5" = constant [20 x i8] c"{\22status\22:\22online\22}\00"
@"str_6" = constant [10 x i8] c"Not Found\00"
@"str_7" = constant [25 x i8] c"Erro ao iniciar servidor\00"
@"str_8" = constant [3 x i8] c"%s\00"
@"str_9" = constant [2 x i8] c"\0a\00"
@"str_10" = constant [34 x i8] c"\f0\9f\9a\80 Lumina-HTTP rodando na porta\00"
@"str_11" = constant [3 x i8] c"%s\00"
@"str_12" = constant [2 x i8] c" \00"
@"str_13" = constant [4 x i8] c"%ld\00"
@"str_14" = constant [2 x i8] c"\0a\00"
@"str_15" = constant [1 x i8] c"\00"
@"str_16" = constant [23 x i8] c"Requisi\c3\a7\c3\a3o recebida:\00"
...
@"str_22" = constant [59 x i8] c"HTTP/1.1 200 OK\0d\0aContent-Type: text/html\0d\0aContent-Length: \00"
@"str_23" = constant [4 x i8] c"%ld\00"
@"str_24" = constant [24 x i8] c"\0d\0aConnection: close\0d\0a\0d\0a\00"
@"str_25" = constant [37 x i8] c"<h1>404 - Pagina Nao Encontrada</h1>\00"
@"str_26" = constant [66 x i8] c"HTTP/1.1 404 Not Found\0d\0aContent-Type: text/html\0d\0aContent-Length: \00"
@"str_27" = constant [4 x i8] c"%ld\00"
@"str_28" = constant [24 x i8] c"\0d\0aConnection: close\0d\0a\0d\0a\00"
@"str_29" = constant [20 x i8] c"Erro ao criar epoll\00"
