...
main_body:
  ...
  %".10" = bitcast [25 x i8]* @"str_3" to i8*
  %"payload" = alloca i8*
  store i8* %".10", i8** %"payload"
  %"payload_load" = load i8*, i8** %"payload"
  %".12" = bitcast [5 x i8]* @"str_4" to i8*
  %"get_str_call" = call i8* @"get_str"(i8* %"payload_load", i8* %".12")
  %"extracted_name" = alloca i8*
  store i8* %"get_str_call", i8** %"extracted_name"
  %"payload_load.1" = load i8*, i8** %"payload"
  %".14" = bitcast [4 x i8]* @"str_5" to i8*
  %"get_int_call" = call i64 @"get_int"(i8* %"payload_load.1", i8* %".14")
  %"extracted_age" = alloca i64
  store i64 %"get_int_call", i64* %"extracted_age"
  %".16" = bitcast [16 x i8]* @"str_6" to i8*
  %".17" = bitcast [3 x i8]* @"str_7" to i8*
  %"print_call.1" = call i32 (i8*, ...) @"printf"(i8* %".17", i8* %".16")
  %"extracted_name_load" = load i8*, i8** %"extracted_name"
  %".18" = bitcast [2 x i8]* @"str_8" to i8*
  %"print_sep" = call i32 (i8*, ...) @"printf"(i8* %".18")
  %".19" = bitcast [3 x i8]* @"str_9" to i8*
  %"print_call.2" = call i32 (i8*, ...) @"printf"(i8* %".19", i8* %"extracted_name_load")
  %".20" = bitcast [2 x i8]* @"str_10" to i8*
  %"print_nl.1" = call i32 (i8*, ...) @"printf"(i8* %".20")
  %".21" = bitcast [17 x i8]* @"str_11" to i8*
  %".22" = bitcast [3 x i8]* @"str_12" to i8*
  %"print_call.3" = call i32 (i8*, ...) @"printf"(i8* %".22", i8* %".21")
  %"extracted_age_load" = load i64, i64* %"extracted_age"
  %".23" = bitcast [2 x i8]* @"str_13" to i8*
  %"print_sep.1" = call i32 (i8*, ...) @"printf"(i8* %".23")
  %".24" = bitcast [4 x i8]* @"str_14" to i8*
  %"print_call.4" = call i32 (i8*, ...) @"printf"(i8* %".24", i64 %"extracted_age_load")
  %".25" = bitcast [2 x i8]* @"str_15" to i8*
  %"print_nl.2" = call i32 (i8*, ...) @"printf"(i8* %".25")
  %"user_lit" = alloca %"User"
  %"name_ptr" = getelementptr %"User", %"User"* %"user_lit", i32 0, i32 0
  %"extracted_name_load.1" = load i8*, i8** %"extracted_name"
  store i8* %"extracted_name_load.1", i8** %"name_ptr"
  %"age_ptr" = getelementptr %"User", %"User"* %"user_lit", i32 0, i32 1
  %"extracted_age_load.1" = load i64, i64* %"extracted_age"
  store i64 %"extracted_age_load.1", i64* %"age_ptr"
  %"user" = alloca %"User"*
  store %"User"* %"user_lit", %"User"** %"user"
  %".29" = bitcast [17 x i8]* @"str_16" to i8*
  %".30" = bitcast [3 x i8]* @"str_17" to i8*
  %"print_call.5" = call i32 (i8*, ...) @"printf"(i8* %".30", i8* %".29")
  %"user_load" = load %"User"*, %"User"** %"user"
  %".31" = getelementptr %"User", %"User"* %"user_load", i32 0, i32 0
  %"name_load" = load i8*, i8** %".31"
  %".32" = bitcast [2 x i8]* @"str_18" to i8*
  %"print_sep.2" = call i32 (i8*, ...) @"printf"(i8* %".32")
  %".33" = bitcast [3 x i8]* @"str_19" to i8*
  %"print_call.6" = call i32 (i8*, ...) @"printf"(i8* %".33", i8* %"name_load")
  %".34" = bitcast [2 x i8]* @"str_20" to i8*
  %"print_nl.3" = call i32 (i8*, ...) @"printf"(i8* %".34")
  %".35" = bitcast [19 x i8]* @"str_21" to i8*
  %".36" = bitcast [3 x i8]* @"str_22" to i8*
  %"print_call.7" = call i32 (i8*, ...) @"printf"(i8* %".36", i8* %".35")
  %"user_load.1" = load %"User"*, %"User"** %"user"
  %".37" = getelementptr %"User", %"User"* %"user_load.1", i32 0, i32 1
  %"age_load" = load i64, i64* %".37"
  %".38" = bitcast [2 x i8]* @"str_23" to i8*
  %"print_sep.3" = call i32 (i8*, ...) @"printf"(i8* %".38")
  %".39" = bitcast [4 x i8]* @"str_24" to i8*
  %"print_call.8" = call i32 (i8*, ...) @"printf"(i8* %".39", i64 %"age_load")
...
get_str_entry:
  ...
  %"key" = alloca i8*
  store i8* %".2", i8** %"key"
  br label %"get_str_body"
get_str_body:
  %".7" = bitcast [2 x i8]* @"str_26" to i8*
  ...
  %"search_str" = alloca i8*
  store i8* %"sconcat_buf.1", i8** %"search_str"
  %"json_load" = load i8*, i8** %"json"
  %"search_str_load" = load i8*, i8** %"search_str"
  %"find_call" = call i64 @"find"(i8* %"json_load", i8* %"search_str_load")
  %"pos" = alloca i64
  store i64 %"find_call", i64* %"pos"
  %"pos_load" = load i64, i64* %"pos"
  %"neg" = sub i64 0, 1
  %"icmp" = icmp eq i64 %"pos_load", %"neg"
  br i1 %"icmp", label %"if_then", label %"if_else"
if_then:
  %".12" = bitcast [1 x i8]* @"str_28" to i8*
  ret i8* %".12"
if_else:
  br label %"if_end"
if_end:
  %"pos_load.1" = load i64, i64* %"pos"
  %"search_str_load.1" = load i8*, i8** %"search_str"
  %"len_str" = call i64 @"strlen"(i8* %"search_str_load.1")
  %"add" = add i64 %"pos_load.1", %"len_str"
  %"start" = alloca i64
  store i64 %"add", i64* %"start"
  %"json_load.1" = load i8*, i8** %"json"
  %"start_load" = load i64, i64* %"start"
  %"substr_call" = call i8* @"substr"(i8* %"json_load.1", i64 %"start_load", i64 100)
  %".16" = bitcast [2 x i8]* @"str_29" to i8*
  %"find_call.1" = call i64 @"find"(i8* %"substr_call", i8* %".16")
  %"end" = alloca i64
  store i64 %"find_call.1", i64* %"end"
  %"end_load" = load i64, i64* %"end"
  %"neg.1" = sub i64 0, 1
  %"icmp.1" = icmp eq i64 %"end_load", %"neg.1"
  br i1 %"icmp.1", label %"if_then.1", label %"if_else.1"
if_then.1:
  %".19" = bitcast [1 x i8]* @"str_30" to i8*
  ret i8* %".19"
if_else.1:
  br label %"if_end.1"
if_end.1:
  %"json_load.2" = load i8*, i8** %"json"
  %"start_load.1" = load i64, i64* %"start"
  %"end_load.1" = load i64, i64* %"end"
  %"substr_call.1" = call i8* @"substr"(i8* %"json_load.2", i64 %"start_load.1", i64 %"end_load.1")
  ret i8* %"substr_call.1"
}

define i64 @"get_int"(i8* %".1", i8* %".2")
{
get_int_entry:
  %"json" = alloca i8*
  store i8* %".1", i8** %"json"
...
if_end:
  ...
  %"start" = alloca i64
  store i64 %"add", i64* %"start"
  %".15" = bitcast [1 x i8]* @"str_33" to i8*
  %"result" = alloca i8*
  store i8* %".15", i8** %"result"
  %"i" = alloca i64
  store i64 0, i64* %"i"
  br label %"while_cond"
while_cond:
  %"i_load" = load i64, i64* %"i"
  %"icmp.1" = icmp slt i64 %"i_load", 20
  br i1 %"icmp.1", label %"while_body", label %"while_end"
while_body:
  %"json_load.1" = load i8*, i8** %"json"
  %"start_load" = load i64, i64* %"start"
  %"i_load.1" = load i64, i64* %"i"
  %"add.1" = add i64 %"start_load", %"i_load.1"
  %".20" = getelementptr i8, i8* %"json_load.1", i64 %"add.1"
  %"ptr_idx_load" = load i8, i8* %".20"
  %"idx_sext" = sext i8 %"ptr_idx_load" to i64
  %"c" = alloca i64
  store i64 %"idx_sext", i64* %"c"
  %"c_load" = load i64, i64* %"c"
  %"icmp.2" = icmp sge i64 %"c_load", 48
  br i1 %"icmp.2", label %"and_rhs", label %"and_end"
while_end:
  %"result_load.1" = load i8*, i8** %"result"
  %"atoi_call" = call i64 @"atoi"(i8* %"result_load.1")
  ret i64 %"atoi_call"
and_rhs:
  %"c_load.1" = load i64, i64* %"c"
  %"icmp.3" = icmp sle i64 %"c_load.1", 57
  br label %"and_end"
and_end:
  %"and_result" = phi  i1 [0, %"while_body"], [%"icmp.3", %"and_rhs"]
  br i1 %"and_result", label %"if_then.1", label %"if_else.1"
if_then.1:
  %"result_load" = load i8*, i8** %"result"
  ...
  %"sconcat_len1.2" = call i64 @"strlen"(i8* %"result_load")
  %"sconcat_len2.2" = call i64 @"strlen"(i8* %"chr_buf")
  ...
  %"sconcat_cpy.2" = call i8* @"strcpy"(i8* %"sconcat_buf.2", i8* %"result_load")
  %"sconcat_cat.2" = call i8* @"strcat"(i8* %"sconcat_buf.2", i8* %"chr_buf")
  store i8* %"sconcat_buf.2", i8** %"result"
  br label %"if_end.1"
if_else.1:
  br label %"while_end"
if_end.1:
...
if_then:
  %".23" = bitcast [1 x i8]* @"str_34" to i8*
  ret i8* %".23"
if_else:
  br label %"if_end"
if_end:
...
split_body:
  ...
  %"i" = alloca i64
  store i64 0, i64* %"i"
  %".12" = bitcast [1 x i8]* @"str_35" to i8*
...
if_then.2:
  ...
  %".37" = bitcast [1 x i8]* @"str_36" to i8*
...
@"str_0" = constant [31 x i8] c"Testando JSON Parser Nativo...\00"
@"str_1" = constant [3 x i8] c"%s\00"
@"str_2" = constant [2 x i8] c"\0a\00"
@"str_3" = constant [25 x i8] c"{\22name\22:\22Adam\22,\22age\22:25}\00"
@"str_4" = constant [5 x i8] c"name\00"
@"str_5" = constant [4 x i8] c"age\00"
@"str_6" = constant [16 x i8] c"Nome extra\c3\addo:\00"
@"str_7" = constant [3 x i8] c"%s\00"
@"str_8" = constant [2 x i8] c" \00"
@"str_9" = constant [3 x i8] c"%s\00"
@"str_10" = constant [2 x i8] c"\0a\00"
@"str_11" = constant [17 x i8] c"Idade extra\c3\adda:\00"
@"str_12" = constant [3 x i8] c"%s\00"
@"str_13" = constant [2 x i8] c" \00"
@"str_14" = constant [4 x i8] c"%ld\00"
@"str_15" = constant [2 x i8] c"\0a\00"
@"str_16" = constant [17 x i8] c"Usu\c3\a1rio criado:\00"
@"str_17" = constant [3 x i8] c"%s\00"
@"str_18" = constant [2 x i8] c" \00"
@"str_19" = constant [3 x i8] c"%s\00"
@"str_20" = constant [2 x i8] c"\0a\00"
@"str_21" = constant [19 x i8] c"Idade do usu\c3\a1rio:\00"
@"str_22" = constant [3 x i8] c"%s\00"
@"str_23" = constant [2 x i8] c" \00"
@"str_24" = constant [4 x i8] c"%ld\00"
@"str_25" = constant [2 x i8] c"\0a\00"
@"str_26" = constant [2 x i8] c"\22\00"
@"str_27" = constant [4 x i8] c"\22:\22\00"
@"str_28" = constant [1 x i8] c"\00"
@"str_29" = constant [2 x i8] c"\22\00"
@"str_30" = constant [1 x i8] c"\00"
@"str_31" = constant [2 x i8] c"\22\00"
@"str_32" = constant [3 x i8] c"\22:\00"
@"str_33" = constant [1 x i8] c"\00"
@"str_34" = constant [1 x i8] c"\00"
@"str_35" = constant [1 x i8] c"\00"
@"str_36" = constant [1 x i8] c"\00"
@"str_37" = constant [1 x i8] c"\00"