...
class BuiltinManager:
    ...
    def setup_builtins(module):
        ...
        strcmp_ty = ir.FunctionType(i32_ty, [voidptr_ty, voidptr_ty])
        ...
        return printf, scanf, atoi, sprintf, malloc_fn, free_fn, fopen, fgets, fputs, fclose, strlen_fn, strcat_fn, strdup_fn, snprintf_fn, strcpy_fn, strcmp_fn