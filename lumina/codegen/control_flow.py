...
class ControlFlowCodegen:
    def codegen_if(self, node: IfStmt):
        ...
        self.builder.position_at_end(then_bb); self.cleanup_vars.append(set())
        ...
        if else_bb:
            self.builder.position_at_end(else_bb); self.cleanup_vars.append(set())
