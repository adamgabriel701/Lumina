        ...
        for line_num, line in enumerate(lines, 1):
            ...
            while i < len(stripped):
                ...
                if c == ' ':
                    ...
                    word = stripped[i:j]
                    if word in ('fn', 'let', 'mut', 'if', 'elif', 'else', 'while', 'for', 'in', 'struct', 'impl', 'import', 'extern', 'enum', 'return', 'print', 'true', 'false', 'match', 'case', 'default', 'and', 'or', 'not', 'continue', 'defer', 'test', 'break', 'assert', 'bench', 'trait', 'comptime', 'as', 'export'):
